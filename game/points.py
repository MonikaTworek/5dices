...
class Points:
    ...
    def sum(self):
        sum=Points.first+Points.second+Points.third+Points.fourth+Points.fifth+Points.sixth
        if (sum<63):
            sum-=50
        sum=sum+Points.pair+Points.two_pair+Points.three+Points.small_street+Points.big_street+Points.full+Points.carriage+Points.poker+Points.chaince
        return sum